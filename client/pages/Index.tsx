        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Interactive Planetary Defense Dashboard for Impactor-2025 Threat Assessment & Response Coordination
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <Card className="bg-card/80 backdrop-blur-sm border-danger/30">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-danger mb-1">T-168h</div>
            ...
            <Card className="bg-card/80 backdrop-blur-sm border-cosmic-nebula/30">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-cosmic-nebula mb-1">12.4%</div>
            ...
            <Card className="bg-card/80 backdrop-blur-sm border-cosmic-comet/30">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-cosmic-comet mb-1">26.1M km</div>
            ...
            <Card className="bg-card/80 backdrop-blur-sm border-cosmic-asteroid/30">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-cosmic-asteroid mb-1">1.2 km</div>
                <div className="text-sm text-muted-foreground">Asteroid Diameter</div>
              </CardContent>
            </Card>
          </div>
                ...
                <Card className="bg-card/80 backdrop-blur-sm border-border/50">
                  ...
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <div className="text-sm text-muted-foreground mb-1">Asteroid Classification</div>
                      ...
                      <div>
                        ...
                        <div className="font-medium text-danger">2025-04-13 14:23 UTC</div>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-border/30">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="outline" className="text-xs bg-cosmic-comet/20 text-cosmic-comet border-cosmic-comet/30">
                            In Progress
                          </Badge>
                        </div>
                        <div className="flex items-center justify-between">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-3 bg-cosmic-void/20 rounded-lg border border-danger/20">
                      ...
                      <div>
                        <div className="font-medium text-sm">Nuclear deflection mission parameters finalized</div>
                        <div className="text-xs text-muted-foreground">5 minutes ago • Mission Director Dr. Sarah Chen</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-3 bg-cosmic-void/20 rounded-lg border border-warning/20">
                      ...
                      <div>
                        <div className="font-medium text-sm">European shelter network 94% complete</div>
                        <div className="text-xs text-muted-foreground">25 minutes ago • Prof. Elena Volkov</div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-3 bg-cosmic-void/20 rounded-lg border border-cosmic-nebula/20">
                      ...
                      <div>
                        <div className="font-medium text-sm">Trajectory update: Impact probability increased to 12.4%</div>
                        <div className="text-xs text-muted-foreground">45 minutes ago • NASA JPL Tracking</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
